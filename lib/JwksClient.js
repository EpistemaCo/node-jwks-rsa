...
var JwksClient = exports.JwksClient = function () {
  function JwksClient(options) {
    ...
    this.getSigningKey = function (kid) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this.getSigningKeys(function (err, keys) {
          ...
          if (!kidDefined && keys.length > 1) {
            ...
            return reject(new _SigningKeyNotFoundError2.default('No KID specified and JWKS endpoint returned more than 1 key'));
          }

          var key = keys.find(function (k) {
            return !kidDefined || k.kid.includes(kid);
          });
          if (key) {
            return resolve(key);
          } else {
            _this.logger('Unable to find a signing key that matches \'' + kid + '\'');
            return reject(new _SigningKeyNotFoundError2.default('Unable to find a signing key that matches \'' + kid + '\''));
          }
        });
      });
    };
